...
export const CHANNELS = ['walkLeft', 'walkRight', 'turnLeft', 'turnRight', 'reverse', 'escape', 'feed'];
// Readout columns contain descending neurons and the MN9 feeding motor neurons.
