...
test('Python process consumes shared population maps, pulse envelopes, and reset', {skip:!process.env.TORCH_TEST_PYTHON}, async t=>{
 ...
 const worker=new PythonSession({python:process.env.TORCH_TEST_PYTHON,directory:dir,format:'full',seed:1,neurons,device:'cpu'});
